...
test("ships the GitHub Pages and Apps Script integration", async () => {
  ...
  assert.match(pages, /syncSnapshotData/);
  ...
  assert.match(pages, /isOfficialPerroNegroProject/);
  assert.match(pages, /hasPerroNegroSeedMovements/);
  assert.match(pages, /Este evento todavia no tiene costos ni ingresos propios/);
